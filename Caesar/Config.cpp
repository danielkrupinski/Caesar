...
void Config::save()
{
    ...
    config["fakelag"] = fakelag.enabled;
    config["fakelag_while_shooting"] = fakelag.whileShooting;
    config["fakelag_type"] = fakelag.type;
    config["fakelag_move"] = fakelag.move;
    config["fakelag_variance"] = fakelag.variance;
    config["fakelag_limit"] = fakelag.limit;
    config["brightness"] = brightness.volume;
    config["brightness_r"] = brightness.r;
    config["brightness_g"] = brightness.g;
    config["brightness_b"] = brightness.b;
    ...
    config["crosshair"] = crosshair.enabled;
    config["crosshair_r"] = crosshair.r;
    config["crosshair_g"] = crosshair.g;
    config["crosshair_b"] = crosshair.b;
