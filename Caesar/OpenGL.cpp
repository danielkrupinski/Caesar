...
void HookOpenGL()
{
	...
	pglBegin = (glBegin_t)DetourAttach((PVOID*)GetProcAddress(hmOpenGL, "glBegin"), (PVOID)&Hooked_glBegin);
	pglColor4f = (glColor4f_t)DetourAttach((PVOID*)GetProcAddress(hmOpenGL, "glColor4f"), (PVOID)&Hooked_glColor4f);
	pglVertex3fv = (glVertex3fv_t)DetourAttach((PVOID*)GetProcAddress(hmOpenGL, "glVertex3fv"), (PVOID)&Hooked_glVertex3fv);
	pglClear = (glClear_t)DetourAttach((PVOID*)GetProcAddress(hmOpenGL, "glClear"), (PVOID)&Hooked_glClear);
	pwglSwapBuffers = (wglSwapBuffers_t)DetourAttach((PVOID*)GetProcAddress(hmOpenGL, "wglSwapBuffers"), (PVOID)&Hooked_wglSwapBuffers);
	pglViewport = (glViewport_t)DetourAttach((PVOID*)GetProcAddress(hmOpenGL, "glViewport"), (PVOID)&Hooked_glViewport);
}